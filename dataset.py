...
def tile_dataset(tile_size, tile_stride_ratio=1.0, img_path=None):
    ...
    for i in img_ls:
        ...
        x_tile, y_tile = img_tile_generator(tile_size, img_pth, mask_pth, tile_stride_ratio=tile_stride_ratio)
...
def img_tile_generator(tile_size, img_pth, mask_pth, tile_stride_ratio=1.0):
